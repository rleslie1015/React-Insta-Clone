...
- xxxRe-factor `SearchBar` to use `styled-components`.
- xxxCreate a `Header` styled-component.header that wraps your entire SearchBar.
...
- Re-factor your `PostContainer` component use only styled components
  ...
  - xxxStart with the `UserThumbnail` and `Username`
